...
void demo_simple_type() {
    print_separator("1: Работа с простым типом (int)");
...
void demo_complex_type() {
    ...
    queue.push(Person("Иванов ", 25, 75000.50));
    std::cout << "  Добавлен: Иванов\n";
    
    queue.push(Person("Петрова ", 30, 92000.75));
    std::cout << "  Добавлена: Петрова \n";
    
    queue.push(Person("Сидоров ", 35, 120000.00));
    std::cout << "  Добавлен: Сидоров\n";
    
    queue.push(Person("Козлова ", 28, 85000.25));
    std::cout << "  Добавлена: Козлова \n";
...
void demo_memory_reuse() {
    print_separator("3: Переиспользование освобождённой памяти");
    ...
    std::cout << "\n 3: Добавление 3 новых элементов\n";
...
void demo_copy_and_move() {
    print_separator(" 4: Копирование и перемещение (Правило пяти)");
...
void demo_iterator_operations() {
    print_separator("5: Операции с итераторами");
...
void demo_edge_cases() {
    print_separator(" 6: Граничные случаи и обработка ошибок");
...
int main() {
    ...
    try {
        ...
        print_separator("завершено успешнр");
